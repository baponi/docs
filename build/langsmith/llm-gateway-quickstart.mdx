...
For details on configuring these variables when using LangChain chat models versus native provider SDKs or other frameworks, see [Configure environment variables](/langsmith/llm-gateway-configure-env).
